...
//    List<Ride> findByDriverId(Long driverId);
    ...
    List<Ride> findByPassengerIdAndStatusIn(Long passengerId, List<String> rideStatus, Pageable pageable);
    List<Ride> findByDriverIdAndStatusIn(Long driverId, List<String> rideStatus, Pageable pageable);
